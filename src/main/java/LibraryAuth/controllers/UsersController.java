package LibraryAuth.controllers;
...
import LibraryAuth.model.RoleToUtenteForm;
import LibraryAuth.model.Utente;
import LibraryAuth.services.UserService;
...
public class UsersController {
    ...
    {
        return ResponseEntity.ok().body(this.serviceUtente.saveRole(ruolo));
    }
